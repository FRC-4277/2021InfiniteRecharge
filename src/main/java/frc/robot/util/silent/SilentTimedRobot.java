 ...
 *
 * <p>TimedRobot implements the IterativeRobotBase robot program framework.
 *
 ...
 */
public class SilentTimedRobot extends SilentIterativeRobotBase {
   ...
   */
  protected SilentTimedRobot(double period) {
    super(period);
