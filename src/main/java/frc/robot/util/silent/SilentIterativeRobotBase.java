...
/**
 * MODIFIED TO NOT PRINT LOOP OVERRUNS
 *
 * <p>IterativeRobotBase implements a specific type of robot program framework, extending the
 * RobotBase class.
 *
 ...
 */
public abstract class SilentIterativeRobotBase extends RobotBase {
   ...
   */
  protected SilentIterativeRobotBase(double period) {
    m_period = period;
