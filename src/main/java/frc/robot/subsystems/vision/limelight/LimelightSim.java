...
public class LimelightSim {
  ...
  private static final NetworkTable NETWORK_TABLE =
  ...
  public static final Pose2d POWER_PORT_LOCATION_GLASS =
      POWER_PORT_LOCATION.plus(
          new Transform2d(new Translation2d(-0.754126 / 2d, 0), new Rotation2d(0)));
  ...
  public static void updateTarget(Pose2d robotPose) {
    ...
    double a1Rad =
        Math.PI
            - MOUNT_ANGLE_RAD
            - (Math.PI * 0.5D - Math.atan(d / (MOUNT_HEIGHT_M - PORT_CENTER_HEIGHT_M)));
