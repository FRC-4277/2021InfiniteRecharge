...
import frc.robot.subsystems.Verification;
import frc.robot.subsystems.VerificationSystem;
import frc.robot.subsystems.vision.limelight.Limelight;
import frc.robot.subsystems.vision.limelight.Pipeline;
import frc.robot.subsystems.vision.limelight.StreamMode;
...
public class VisionSystem extends SubsystemBase implements VerifiableSystem {
  ...
  private GalacticVision galacticVision;
  ...
  public GalacticVision getGalacticVision() {
    return galacticVision;
  }
  ...
  public frc.robot.commands.autonomous.galacticsearch.GalacticPath getSimPathSelected2() {
    if (simulatedPathChooser == null) {
      return null;
    }
    GalacticPath selected = simulatedPathChooser.getSelected();
    if (selected == GalacticPaths.A_RED) {
      return frc.robot.commands.autonomous.galacticsearch.GalacticPaths.A_RED;
    } else if (selected == GalacticPaths.B_RED) {
      return frc.robot.commands.autonomous.galacticsearch.GalacticPaths.B_RED;
    } else if (selected == GalacticPaths.A_BLUE) {
      return frc.robot.commands.autonomous.galacticsearch.GalacticPaths.A_BLUE;
    } else if (selected == GalacticPaths.B_BLUE) {
      return frc.robot.commands.autonomous.galacticsearch.GalacticPaths.B_BLUE;
    }
