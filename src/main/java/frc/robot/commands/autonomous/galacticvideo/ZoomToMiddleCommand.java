...
public class ZoomToMiddleCommand extends CommandBase {
    ...
    public ZoomToMiddleCommand(GalacticAutoVideoCommand galacticAutoVideoCommand, DriveTrain driveTrain) {
    ...
    public void initialize() {
        ...
        Pose2d target = new Pose2d(Units.feetToMeters(6*2.5), Units.feetToMeters(15d / 2), new Rotation2d());
