...
public class FirstForwardMoveCommand extends CommandBase {
    ...
    public FirstForwardMoveCommand(GalacticAutoVideoCommand galacticAutoVideoCommand, DriveTrain driveTrain) {
    ...
    public void initialize() {
        ...
        double distanceForward = path.isPowerCellClose() ?
                GalacticSearchVideo.CLOSE_BALL_DISTANCE : GalacticSearchVideo.FAR_BALL_DISTANCE;
        distanceForward -= GalacticSearchVideo.DESIRED_DISTANCE_TO_BALL;
        galacticAutoVideoCommand.setMessage("[First Forward] Distance forward calculated to be " + distanceForward);
