...
public class GalacticPath {
  ...
  public GalacticPath(
      PathColor color,
      PathLetter letter,
      Translation2d firstPowerCell,
      Translation2d secondPowerCell,
      Translation2d thirdPowerCell) {
    this.color = color;
    this.letter = letter;
  ...
  public static GalacticPath fromFeet(
      PathColor color,
      PathLetter letter,
      Translation2d firstPowerCell,
      Translation2d secondPowerCell,
      Translation2d thirdPowerCell) {
    Translation2d firstPowerCellM =
        new Translation2d(
            Units.feetToMeters(firstPowerCell.getX()), Units.feetToMeters(firstPowerCell.getY()));
    Translation2d secondPowerCellM =
        new Translation2d(
            Units.feetToMeters(secondPowerCell.getX()), Units.feetToMeters(secondPowerCell.getY()));
    Translation2d thirdPowerCellM =
        new Translation2d(
            Units.feetToMeters(thirdPowerCell.getX()), Units.feetToMeters(thirdPowerCell.getY()));
