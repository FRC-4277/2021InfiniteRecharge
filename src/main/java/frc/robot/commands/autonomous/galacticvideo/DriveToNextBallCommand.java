...
public class DriveToNextBallCommand extends CommandBase {
  ...
  public DriveToNextBallCommand(
      GalacticAutoVideoCommand galacticAutoVideoCommand, DriveTrain driveTrain, int ballIndex) {
  ...
  public void initialize() {
    ...
    Translation2d ballPosition =
        galacticAutoVideoCommand.getPathDetected().getThreePowerCells().get(ballIndex);
    ...
    Trajectory trajectory =
        driveTrain.generateTrajectory(currentPosition, targetPosition, 1, 0.5, false, false);
