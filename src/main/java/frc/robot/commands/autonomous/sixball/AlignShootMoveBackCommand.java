...
public class AlignShootMoveBackCommand extends SequentialCommandGroup {
  /** Creates a new AlignShootMoveBackCommand. */
  public AlignShootMoveBackCommand(DriveTrain driveTrain, VisionSystem visionSystem, Shooter shooter, VerticalHopper hopper, boolean seekRight) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ResetOdometryCommand(driveTrain, new Pose2d()),
      new VisionAlignCommand(driveTrain, visionSystem, false, seekRight, false, true).withTimeout(2.5),
      new ShootAndHopperCommand(shooter, hopper, visionSystem, RPMSource.VISION, false).withTimeout(8.0),
