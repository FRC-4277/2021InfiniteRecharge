...
public class ErodeDilatePipeline extends Pipeline {
  private Setting<Integer> closeWidth =
      new Setting<>("closeWidth", Integer.class, 3, BuiltInWidgets.kTextView);
  private Setting<Integer> closeHeight =
      new Setting<>("closeHeight", Integer.class, 3, BuiltInWidgets.kTextView);
  ...
  public void process(Mat mat, Context context) {
    ...
    Mat kernel =
        Imgproc.getStructuringElement(
            Imgproc.MORPH_CROSS, new Size(closeWidth, closeHeight)); // todo : cache
