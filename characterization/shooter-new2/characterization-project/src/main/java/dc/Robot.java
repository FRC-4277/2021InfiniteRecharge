...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonSRX leftMotor = setupWPI_TalonSRX(30, Sides.LEFT, false);
    leftMotor.setSensorPhase(false); // ANDREW ADD

    WPI_TalonSRX leftFollowerID31 = setupWPI_TalonSRX(31, Sides.FOLLOWER, true);
    leftFollowerID31.follow(leftMotor);
    //leftFollowerID31.setSensorPhase(false); // ANDREW ADD (NOT NEEDED)
