...
public class VerticalHopperWidget extends SimpleAnnotatedWidget<VerticalHopper> {
  ...
  private Image[] topArrow =
      new Image[] {loadImage("top_arrow_1.png"), loadImage("top_arrow_2.png")};
  private Image[] bottomArrow =
      new Image[] {loadImage("bottom_arrow_1.png"), loadImage("bottom_arrow_2.png")};
