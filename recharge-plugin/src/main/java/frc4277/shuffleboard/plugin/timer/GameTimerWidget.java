...
public class GameTimerWidget extends SimpleAnnotatedWidget<GameTimer> {
  ...
  private Property<Color> normalColor =
      new SimpleObjectProperty<>(this, "normalColor", Color.WHITE);
  private Property<Color> warningColor =
      new SimpleObjectProperty<>(this, "warningColor", Color.RED);
  private DoubleProperty verticalPadding = new SimpleDoubleProperty(this, "verticalPadding", 0.0);
  private BooleanProperty showMilliseconds =
      new SimpleBooleanProperty(this, "showMilliseconds", false);
  ...
  public void initialize() {
    ...
    Consumer<Double> paddingConsumer =
        padding -> textFlow.setPadding(new Insets(padding, 0, padding, 0));
    paddingConsumer.accept((verticalPadding.get()));
    verticalPadding.addListener(
